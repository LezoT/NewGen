...
bot.on("message", message => {
    if (message.channel.id === "670691506943819837") { //This will make the bot work only in that channel
                        ...
                        if (position != -1) {
                            ...
                            fs.writeFile(filePath, data, function (err) {
                                const embed = {
                                    ...
                                    color: 8519796,
                                    timestamp: "2020-01-31T14:16:26.398Z",
                                    footer: {
                                        icon_url: "https://cdn.discordapp.com/avatars/670670669452804145/813d2d84731deddd12f915f982364d65.png",
                                        text: "Buy discord accounts from LezoT#8106"
                                    },
                                    thumbnail: {
...
bot.login("NjcyNTMzOTc3OTk4OTUwNDIw.XjM4Pw.OBd5EzGVQHPqeHdx0IES32W32Sw");